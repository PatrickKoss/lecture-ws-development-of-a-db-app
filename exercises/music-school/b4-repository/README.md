...
Der lauffähige Stand liegt in `../b3-jdbc/starter`. `starter/MusicCourseCatalog.java` ist die vorbereitete aufrufende Schicht.
...
Kopiert `MusicCourseCatalog` in das B3-Projekt. Verschiebt alle SQL-Zugriffe hinter `MusicCourseRepository`. Die aufrufende Schicht darf weder Connection noch ResultSet kennen.

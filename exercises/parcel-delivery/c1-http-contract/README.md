...
Nutzt das Modell `Parcel` aus B3. `openapi.yaml` enthält Pfad und Statuscodes, aber noch keine Schemas.
...
Definiert Request und Response für GET und POST. Legt Pflichtfelder, `Location`-Header und einen Konflikt fest: `tracking_code` darf nicht doppelt vorkommen.

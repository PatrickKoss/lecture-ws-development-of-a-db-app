...
Schreibt vier Abfragen: einen Filter auf `parcels`, einen INNER JOIN, einen LEFT JOIN und eine Aggregation mit GROUP BY. Jede Abfrage bekommt einen Satz zur erwarteten Ergebnismenge.
...
Die Lehrperson kann fertige Seed-Daten aus `instructor-solutions/parcel-delivery/sql/seed.sql` freigeben. Die Abfragen bleiben eure Arbeit.

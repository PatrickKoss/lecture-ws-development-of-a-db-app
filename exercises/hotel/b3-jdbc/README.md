...
Hebt euren lauffähigen B3-Stand für B4 auf. Die JDBC-Implementierung bleibt dort erhalten. In B4 bereinigt ihr die öffentliche Schnittstelle `RoomTypeRepository`, damit die aufrufende Schicht keine geprüften JDBC-Ausnahmen mehr kennt.

...
Falls der Kern nach 20 Minuten nicht läuft, gibt die Lehrperson `instructor-solutions/car-workshop/sql/schema.sql` frei. Übernehmt nur die Tabellen, die ihr für `Ersatzteil` braucht.

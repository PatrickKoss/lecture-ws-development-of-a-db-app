...
Der lauffähige Stand liegt in `../b3-jdbc/starter`. `starter/CourseCatalog.java` ist die vorbereitete aufrufende Schicht.
...
Kopiert `CourseCatalog` in das B3-Projekt. Verschiebt alle SQL-Zugriffe hinter `CourseRepository`. Die aufrufende Schicht darf weder Connection noch ResultSet kennen.

...
Der lauffähige Stand liegt in `../b3-jdbc/starter`. `starter/BookCatalog.java` ist die vorbereitete aufrufende Schicht.
...
Kopiert `BookCatalog` in das B3-Projekt. Verschiebt alle SQL-Zugriffe hinter `BookRepository`. Die aufrufende Schicht darf weder Connection noch ResultSet kennen.

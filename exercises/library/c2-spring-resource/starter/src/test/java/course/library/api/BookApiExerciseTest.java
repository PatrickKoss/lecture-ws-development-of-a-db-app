  ...
  void createsAndRejectsDuplicateBusinessKeys() throws Exception {
    mvc.perform(
            post("/api/books")
                ...
                .content(
                    "{\"isbn\": \"9780000000000\", \"title\": \"Testbuch\", \"publicationYear\":"
                        + " 2026, \"subjectArea\": \"Informatik\", \"shelfCode\": \"I-99\"}"))
    ...
    mvc.perform(
            post("/api/books")
                .contentType(MediaType.APPLICATION_JSON)
                .content(
                    "{\"isbn\": \"9783446279899\", \"title\": \"Testbuch\", \"publicationYear\":"
                        + " 2026, \"subjectArea\": \"Informatik\", \"shelfCode\": \"I-99\"}"))

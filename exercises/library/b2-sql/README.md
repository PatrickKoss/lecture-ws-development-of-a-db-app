...
Schreibt vier Abfragen: einen Filter auf `books`, einen INNER JOIN, einen LEFT JOIN und eine Aggregation mit GROUP BY. Jede Abfrage bekommt einen Satz zur erwarteten Ergebnismenge.
...
Die Lehrperson kann fertige Seed-Daten aus `instructor-solutions/library/sql/seed.sql` freigeben. Die Abfragen bleiben eure Arbeit.

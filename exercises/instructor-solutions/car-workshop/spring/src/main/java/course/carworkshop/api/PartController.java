...
@Tag(name = "Part", description = "HTTP-Ressource für Ersatzteile")
public class PartController {
  ...
  @Operation(summary = "Ersatzteile auflisten")
  @ApiResponse(
      responseCode = "200",
      description = "Nach ID sortierte Liste",
      content =
          @Content(array = @ArraySchema(schema = @Schema(implementation = PartResponse.class))))
  @ApiResponse(
      responseCode = "406",
  ...
  @Operation(summary = "Part nach ID lesen")
  @ApiResponse(
      responseCode = "200",
  ...
  @ApiResponse(
      ...
      content = @Content(schema = @Schema(implementation = ApiError.class)))
  @GetMapping("/{id}")
  public PartResponse findById(@PathVariable @Positive long id) {
  ...
  @ApiResponse(
      responseCode = "409",
      description = "part_number ist vergeben oder eine Datenbankregel wird verletzt",
      content = @Content(schema = @Schema(implementation = ApiError.class)))
  @ApiResponse(
      responseCode = "415",
  ...
  public ResponseEntity<PartResponse> create(@Valid @RequestBody CreatePartRequest request) {
    var response = PartResponse.from(service.create(request.toCommand()));
    var location =
  ...
  @Operation(summary = "Part vollständig ersetzen")
  @ApiResponse(
      responseCode = "200",
  ...
  public PartResponse replace(
      @PathVariable @Positive long id, @Valid @RequestBody UpdatePartRequest request) {
    return PartResponse.from(service.replace(id, request.toCommand()));
  }

  @Operation(
      summary = "Part löschen",

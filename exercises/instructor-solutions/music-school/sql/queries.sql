...
-- erwartet: 3 Zeilen, MU-02, MU-03 und MU-01 nach Gebühr aufsteigend
...
-- erwartet: 3 Zeilen, MU-04 erscheint wegen der fehlenden room_id nicht
...
-- erwartet: 1 Zeile, MU-04 bleibt durch den LEFT JOIN erhalten
...
-- erwartet: 3 Zeilen, der LEFT JOIN bewahrt auch Lehrkräfte ohne Kurs

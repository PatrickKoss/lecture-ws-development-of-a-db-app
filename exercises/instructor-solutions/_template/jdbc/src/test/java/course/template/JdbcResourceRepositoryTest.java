...
class JdbcResourceRepositoryTest {
  ...
  @Test
  void rejectsADuplicateResourceCode() throws Exception {
    var candidate = new Resource(null, "R-99", "Neue Ressource", new BigDecimal("12.50"));
    repository.insert(candidate);
    var duplicateKey = new Resource(null, "R-99", "Andere Ressource", new BigDecimal("7.00"));

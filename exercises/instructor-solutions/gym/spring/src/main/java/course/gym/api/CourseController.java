...
@Tag(name = "Course", description = "HTTP-Ressource für Kurse")
public class CourseController {
  ...
  @Operation(summary = "Kurse auflisten")
  @ApiResponse(
      responseCode = "200",
      description = "Nach ID sortierte Liste",
      content =
          @Content(array = @ArraySchema(schema = @Schema(implementation = CourseResponse.class))))
  @ApiResponse(
      responseCode = "406",
  ...
  @Operation(summary = "Course nach ID lesen")
  @ApiResponse(
      responseCode = "200",
  ...
  @ApiResponse(
      ...
      content = @Content(schema = @Schema(implementation = ApiError.class)))
  @GetMapping("/{id}")
  public CourseResponse findById(@PathVariable @Positive long id) {
  ...
  public ResponseEntity<CourseResponse> create(@Valid @RequestBody CreateCourseRequest request) {
    var response = CourseResponse.from(service.create(request.toCommand()));
    var location =
  ...
  @Operation(summary = "Course vollständig ersetzen")
  @ApiResponse(
      responseCode = "200",
  ...
  public CourseResponse replace(
      @PathVariable @Positive long id, @Valid @RequestBody UpdateCourseRequest request) {
    return CourseResponse.from(service.replace(id, request.toCommand()));
  }

  @Operation(
      summary = "Course löschen",

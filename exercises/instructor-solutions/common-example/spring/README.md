...
Dieses Projekt ist die vollständige JPA-Lösung für das gemeinsame Beispiel. Die Übungsfassung liegt unter [`common-example/exercises/c2-spring-resource/starter`](../../../../common-example/exercises/c2-spring-resource/starter).
...
Flyway lädt das Schema und alle Seed-Daten aus `src/main/resources/db/migration`. Die Migrationskopie entfernt nur `PRAGMA`, `BEGIN TRANSACTION` und `COMMIT`, weil Flyway Verbindung und Transaktion selbst verwaltet.

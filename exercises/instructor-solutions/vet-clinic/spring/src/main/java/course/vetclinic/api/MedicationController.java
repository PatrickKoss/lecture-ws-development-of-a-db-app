...
public class MedicationController {
  ...
  @Operation(summary = "Alle Medikamente lesen", operationId = "listMedications")
  @ApiResponse(
      responseCode = "200",
      description = "Liste aller Medikamente",
      content =
          @Content(
  ...
  @Operation(summary = "Medikament lesen", operationId = "getMedication")
  @ApiResponse(
      responseCode = "200",
      description = "Medikament gefunden",
      content =
          @Content(
              mediaType = "application/json",
  ...
  @ApiResponse(
      responseCode = "404",
      description = "Medikament nicht gefunden",
      content =
          @Content(
              mediaType = "application/json",
  ...
  @ApiResponse(
      responseCode = "201",
      description = "Medikament angelegt",
      headers =
          @Header(
              name = "Location",
  ...
  @ApiResponse(
      responseCode = "409",
      description = "pzn darf nicht doppelt vorkommen",
      content =
          @Content(
              mediaType = "application/json",
              schema = @Schema(implementation = ApiError.class)))

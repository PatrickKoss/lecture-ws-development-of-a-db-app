...
@Tag(name = "Book", description = "HTTP-Ressource für Bücher")
public class BookController {
  ...
  @Operation(summary = "Bücher auflisten")
  @ApiResponse(
      responseCode = "200",
      description = "Nach ID sortierte Liste",
      content =
          @Content(array = @ArraySchema(schema = @Schema(implementation = BookResponse.class))))
  @ApiResponse(
      responseCode = "406",
  ...
  @Operation(summary = "Book nach ID lesen")
  @ApiResponse(
      responseCode = "200",
  ...
  @ApiResponse(
      ...
      content = @Content(schema = @Schema(implementation = ApiError.class)))
  @GetMapping("/{id}")
  public BookResponse findById(@PathVariable @Positive long id) {
    return BookResponse.from(service.findById(id));
  }

  @Operation(summary = "Book anlegen")
  @ApiResponse(
      responseCode = "201",
  ...
  @ApiResponse(
      responseCode = "409",
      description = "isbn ist vergeben oder eine Datenbankregel wird verletzt",
      content = @Content(schema = @Schema(implementation = ApiError.class)))
  @ApiResponse(
      responseCode = "415",
  ...
  public ResponseEntity<BookResponse> create(@Valid @RequestBody CreateBookRequest request) {
    var response = BookResponse.from(service.create(request.toCommand()));
    var location =
  ...
  @Operation(summary = "Book vollständig ersetzen")
  @ApiResponse(
      responseCode = "200",
  ...
  public BookResponse replace(
      @PathVariable @Positive long id, @Valid @RequestBody UpdateBookRequest request) {
    return BookResponse.from(service.replace(id, request.toCommand()));
  }

  @Operation(
      summary = "Book löschen",

...
Der lauffähige Stand liegt in `../b3-jdbc/starter`. `starter/VenueCatalog.java` ist die vorbereitete aufrufende Schicht.
...
Kopiert `VenueCatalog` in das B3-Projekt. Verschiebt alle SQL-Zugriffe hinter `VenueRepository`. Die aufrufende Schicht darf weder Connection noch ResultSet kennen.

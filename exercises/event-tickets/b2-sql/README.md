...
Schreibt vier Abfragen: einen Filter auf `venues`, einen INNER JOIN, einen LEFT JOIN und eine Aggregation mit GROUP BY. Jede Abfrage bekommt einen Satz zur erwarteten Ergebnismenge.
...
Die Lehrperson kann fertige Seed-Daten aus `instructor-solutions/event-tickets/sql/seed.sql` freigeben. Die Abfragen bleiben eure Arbeit.

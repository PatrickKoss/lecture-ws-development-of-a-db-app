...
Der lauffähige Stand liegt in `../b3-jdbc/starter`. `starter/MovieCatalog.java` ist die vorbereitete aufrufende Schicht.
...
Kopiert `MovieCatalog` in das B3-Projekt. Verschiebt alle SQL-Zugriffe hinter `MovieRepository`. Die aufrufende Schicht darf weder Connection noch ResultSet kennen.

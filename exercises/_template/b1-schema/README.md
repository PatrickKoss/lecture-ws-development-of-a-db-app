...
Falls der Kern nach 20 Minuten nicht läuft, gibt die Lehrperson `instructor-solutions/_template/sql/schema.sql` frei. Übernehmt nur die Tabellen, die ihr für `Hauptressource` braucht.

...
Der lauffähige Stand liegt in `../b3-jdbc/starter`. `starter/RestaurantCatalog.java` ist die vorbereitete aufrufende Schicht.
...
Kopiert `RestaurantCatalog` in das B3-Projekt. Verschiebt alle SQL-Zugriffe hinter `RestaurantRepository`. Die aufrufende Schicht darf weder Connection noch ResultSet kennen.

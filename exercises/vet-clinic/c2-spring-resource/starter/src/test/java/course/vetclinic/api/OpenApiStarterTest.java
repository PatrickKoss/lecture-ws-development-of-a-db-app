...
class OpenApiStarterTest {
  ...
  void generatesContractWithoutCallingUnfinishedRepositoryMethods() throws Exception {
    mvc.perform(get("/v3/api-docs"))
        ...
        .andExpect(
            jsonPath("$.components.schemas.CreateMedicationRequest.properties.id").doesNotExist())
        .andExpect(
            jsonPath("$.components.schemas.MedicationResponse.properties.id.readOnly").value(true));
  }
}

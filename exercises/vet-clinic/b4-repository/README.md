...
Der lauffähige Stand liegt in `../b3-jdbc/starter`. `starter/MedicationCatalog.java` ist die vorbereitete aufrufende Schicht.
...
Kopiert `MedicationCatalog` in das B3-Projekt. Verschiebt alle SQL-Zugriffe hinter `MedicationRepository`. Die aufrufende Schicht darf weder Connection noch ResultSet kennen.

...
public class StationController {
  ...
  @ApiResponse(
      responseCode = "409",
      description = "station_code ist vergeben oder eine Datenbankregel wird verletzt",
      content = @Content(schema = @Schema(implementation = ApiError.class)))
  @ApiResponse(
      responseCode = "415",
  ...
  public ResponseEntity<StationResponse> create(@Valid @RequestBody CreateStationRequest request) {
    var response = StationResponse.from(service.create(request.toCommand()));
    var location =
  ...
  @Operation(summary = "Station vollständig ersetzen")
  @ApiResponse(
      responseCode = "200",
  ...
  public StationResponse replace(
      @PathVariable @Positive long id, @Valid @RequestBody UpdateStationRequest request) {
    return StationResponse.from(service.replace(id, request.toCommand()));
  }

  @Operation(
      summary = "Station löschen",

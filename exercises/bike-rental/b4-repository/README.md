...
Der lauffähige Stand liegt in `../b3-jdbc/starter`. `starter/StationCatalog.java` ist die vorbereitete aufrufende Schicht.
...
Kopiert `StationCatalog` in das B3-Projekt. Verschiebt alle SQL-Zugriffe hinter `StationRepository`. Die aufrufende Schicht darf weder Connection noch ResultSet kennen.

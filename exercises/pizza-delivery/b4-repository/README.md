...
Der lauffähige Stand liegt in `../b3-jdbc/starter`. `starter/PizzaCatalog.java` ist die vorbereitete aufrufende Schicht.
...
Kopiert `PizzaCatalog` in das B3-Projekt. Verschiebt alle SQL-Zugriffe hinter `PizzaRepository`. Die aufrufende Schicht darf weder Connection noch ResultSet kennen.

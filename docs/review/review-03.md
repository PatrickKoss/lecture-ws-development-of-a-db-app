...
| 3/7/1         | `slide-45-fragment-01.png` | Die Folie zeigt `grade TEXT NULL`. In `common-example/sql/schema.sql` ist `grade` als `REAL CHECK (grade BETWEEN 1.0 AND 5.0)` definiert. | blockiert                          |
